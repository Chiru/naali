...
#locationreader = csv.reader(open('pyplugins/clocationscrn.csv', 'rb'), delimiter=',') #Fixed enter and exit nodes
#codreader = csv.reader(open('pyplugins/odcorn.csv', 'rb'), delimiter=',') ##Fixed enter and exit nodes
...
class OriginContainer(object):
    ...
    def __init__(self):
        ...
        self.locationreader = csv.reader(open('pyplugins/clocations.csv', 'rb'), delimiter=',')
        self.codreader = csv.reader(open('pyplugins/cod.csv', 'rb'), delimiter=',')

        #self.locationreader = csv.reader(open('pyplugins/clocationscrn.csv', 'rb'), delimiter=',') #Fixed enter and exit nodes
        #self.codreader = csv.reader(open('pyplugins/odcorn.csv', 'rb'), delimiter=',') ##Fixed enter and exit nodes
    ...
    def update_weights(self,day,hour):
        ...
        if self.number_of_agents > 40: self.number_of_agents = 40
        self.od = od
